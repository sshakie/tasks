...
print(post('http://localhost:5000/api/jobs',
           json={'job': 'da', 'team_leader': 1, 'work_size': 1, 'collaborators': '1,2', 'is_finished': True}).json(),
      '+')  # все работает
...
print(post('http://localhost:5000/api/jobs',
           json={'job': 'da', 'work_size': 1}).json(), '-')  # не хватает 2 обязательных компонента
print(post('http://localhost:5000/api/jobs',
           json={}).json(), '-')  # пустой json
print(post('http://localhost:5000/api/jobs',
           json={'job': 'da', 'team_leader': 1, 'work_size': 1, 'collaborators': '1,2', 'is_finished': True,
